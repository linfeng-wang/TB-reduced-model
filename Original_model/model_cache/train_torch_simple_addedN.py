...
import util
import model_torch_simple_added
from torchmetrics import Accuracy

model_torch_simple_added = reload(model_torch_simple_added)
...
model = model_torch_simple_added.raw_seq_model().to(device) # model = nn.Sequential(nn.Linear(1, 1)).to(device)
