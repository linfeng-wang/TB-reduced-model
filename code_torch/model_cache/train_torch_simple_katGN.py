#using two sequences to predict inh, with all na dropped
#%%
...
train_frames = [seqs_df['rpsA'],seqs_df['KatG'], res_all['ISONIAZID']]
...
train_frames['train'] = train_frames["rpsA"] + train_frames["KatG"]
